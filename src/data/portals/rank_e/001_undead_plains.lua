    ...
    hordeConfig = {
        ...
        phases = {
            -- Fase 1: Apenas Walkers (0-2 minutos)
            {
                duration = 120,
                spawnPatterns = {
                    { type = "Wave", enemyClass = ZombieRunnerMale1,   interval = 2, count = 5, maxConcurrent = 50, strategy = "offscreen" },
                    { type = "Wave", enemyClass = ZombieRunnerFemale1, interval = 1, count = 5, maxConcurrent = 50, strategy = "offscreen" },
                }
            },

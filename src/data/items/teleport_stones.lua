local teleport_stones = {
    teleport_stone_d = {
        ...
        icon = "assets/items/teleport_stone_d.png", -- Exemplo de caminho
        stackable = true,
        maxStack = 10,
        gridWidth = 1,
        gridHeight = 1,
    ...
    teleport_stone_a = {
        ...
        icon = "assets/items/teleport_stone_a.png", -- Exemplo de caminho
        stackable = true,
        maxStack = 5,
        gridWidth = 1,
        gridHeight = 1,
    ...
    teleport_stone_s = {
        ...
        icon = "assets/items/teleport_stone_s.png", -- Exemplo de caminho
        stackable = true,
        maxStack = 1,
        gridWidth = 1,
        gridHeight = 1,
    ...
    teleport_stone_b = {
        ...
        icon = "assets/items/teleport_stone_b.png", -- Exemplo de caminho
        stackable = true,
        maxStack = 5,
        gridWidth = 1,
        gridHeight = 1,

...
local bosses = {
    the_rotten_immortal = {
        ...
        frameTimes = {
            walk = 0.14, -- Segundos por frame
            run = 0.14,  -- Segundos por frame
            taunt = 0.1, -- Segundos por frame
            idle = 0.14, -- Segundos por frame
            death_die1 = 0.15,
            death_die2 = 0.15,
            attack = 0.14
        },
        ...
        abilities = {
            {
                ...
                params = {
                    ...
                    dashSpeedMultiplier = 10, -- Multiplicador de velocidade durante o avanço
            ...
            },
            {
                ...
                params = {
                    ...
                    followUpRadiusIncrease = 1.5,
                    followUpStunIncrease = 0.8
                }
            },
            {

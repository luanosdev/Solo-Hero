...
local Bow = BaseWeapon:new({
    itemBaseId = "bow",                    -- Identificador para buscar dados em weapons.lua
    -- Propriedades específicas do ataque/visualização (mantidas)
    angle = math.rad(30),                  -- Ângulo do cone de disparo das flechas
    baseProjectiles = 3,                   -- Número base de flechas (Poderia ir para weapons.lua se preferir)
